...
int main(int argc, char* argv[])
{
    if (argc < 14 || argc > 16) {
        ...
        FT_LOG_ERROR("e.g. ./bin/bart_gemm 8 4 32 512 8 64 2048 512 8 64 2048 32100 1 2 0");
        return 0;
    }
    ...
    void*  gemm_test_buf;
    size_t buf_size_in_byte = ft::calBartGemmTestBufSizeInByte(batch_size,
                                                               beam_width,
                                                               max_mem_seq_len,
                                                               encoder_d_model,
                                                               encoder_head_num,
    ...
    if (data_type == ft::FLOAT_DATATYPE) {
        ft::generate_bart_gemm_config<float>(batch_size,
                                             beam_width,
                                             max_mem_seq_len,
                                             encoder_d_model,
                                             encoder_head_num,
        ...
        ft::generate_bart_gemm_config<half>(batch_size,
                                            beam_width,
                                            max_mem_seq_len,
                                            encoder_d_model,
                                            encoder_head_num,
        ...
        ft::generate_bart_gemm_config<__nv_bfloat16>(batch_size,
                                                     beam_width,
                                                     max_mem_seq_len,
                                                     encoder_d_model,
                                                     encoder_head_num,
